...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.outrick.net/blog/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.description,
      url: `https://www.outrick.net/blog/${post.slug}`,
      siteName: 'Outrick',
      locale: 'en_US',
      type: 'article',
...
export default async function PostPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    headline: post.title,
    description: post.description,
    image: `https://www.outrick.net/blog/${post.slug}/opengraph-image`,
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://www.outrick.net/blog' },
        { '@type': 'ListItem', position: 3, name: post.title, item: `https://www.outrick.net/blog/${post.slug}` },
      ],
    },
  };
